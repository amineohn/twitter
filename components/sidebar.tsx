const Sidebar = () => {
  return (
    <div className="border-r border-r-neutral-700">
      <div className="w-full h-screen">
        <div className="flex justify-end items-end w-[535px]">
          <div className="px-4 py-5 flex flex-col space-y-2.5 w-[270px] h-screen">
            <svg
              viewBox="0 0 24 24"
              aria-hidden="true"
              className="w-7 h-8 text-white ml-3"
            >
              <g>
                <path
                  fill="currentColor"
            ...
            <a
              href=""
              className="text-gray-100 hover:bg-neutral-800/60 pb-1 pt-2 pr-8 pl-3 max-w-[150px] rounded-full transition"
            >
              <div className="inline-flex space-x-4 items-center justify-center">
                <svg
                  viewBox="0 0 24 24"
                  aria-hidden="true"
                  className="w-7 h-8 text-gray-100"
                >
                  <g>
                    <path
                      fill="currentColor"
            ...
            <a
              href=""
              className="text-gray-100   hover:bg-neutral-800/60 pb-1 pt-2 pr-8 pl-3 max-w-[140px] rounded-full transition"
            >
              <div className="inline-flex space-x-4 items-center justify-center">
                <svg
                  viewBox="0 0 24 24"
                ...
                <span className="font-normal text-lg">Explore</span>
              </div>
            </a>
            <a
              href=""
              className="text-gray-100 hover:bg-neutral-800/60 pb-1 pt-2 pr-8 max-w-[190px] pl-3 rounded-full transition"
            >
              <div className="inline-flex space-x-4 items-center justify-center">
                <svg
                  viewBox="0 0 24 24"
                ...
                <span className="font-normal text-lg">Notifications</span>
              </div>
            </a>
            <a
              href=""
              className="text-gray-100 hover:bg-neutral-800/60 pb-1 pt-2 pr-8 pl-3 max-w-[170px] rounded-full transition"
            >
              <div className="inline-flex space-x-4 items-center justify-center">
                <svg
                  viewBox="0 0 24 24"
            ...
            >
              <div className="inline-flex space-x-4 items-center justify-center">
                ...
                <span className="font-normal text-lg">Bookmarks</span>
              </div>
            </a>
            <a
              href=""
              className="text-gray-100 hover:bg-neutral-800/60 pb-1 pt-2 pr-8 pl-3 max-w-[120px] rounded-full transition"
            >
              <div className="inline-flex space-x-4 items-center justify-center">
                <svg
                  viewBox="0 0 24 24"
            ...
            >
              <div className="inline-flex space-x-4 items-center justify-center">
                ...
                <span className="font-normal text-lg">Profile</span>
              </div>
            </a>
            <a
              href=""
                ...
                >
                  <g>
                    ...
                    <circle
                      ...
                      r="1.5"
                    ></circle>
                    <circle fill="currentColor" cx="7" cy="12" r="1.5"></circle>
                    <path
                      fill="currentColor"
            ...
            <button className="bg-sky-500 hover:bg-sky-500/95 transition-colors ease-in-out px-12 py-4 rounded-full text-white font-medium">
              Tweet
            </button>
            <div className="bottom-0 absolute py-4">
              <div className="w-[250px] h-[60px] rounded-full hover:bg-white/10 transition select-none">
                <div className="flex justify-between items-center mx-3">
                  <div className="inline-flex space-x-2 items-center justify-center my-2">
                    <img
                    ...
                    <div className="flex flex-col">
                      ...
                      <span className="text-sm text-neutral-600">@twitter</span>
                    </div>
                  </div>
                  <svg
                    viewBox="0 0 24 24"
